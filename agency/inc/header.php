<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
  <h3 class="mb-0 h-font">Houston Travels</h3>
...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid flex-lg-column align-items-stretch">
      <h4 class="mt-2 text-light">Travel Agency Panel</h4>
      ...
      <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            ...
            <div class="collapse show px-3 small mb-1" id="bookingLinks">
              <ul class="nav nav-pills flex-column rounded border border-secondary">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="flight_bookings.php">Flight Booking Records</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="tour_bookings.php">Tour Booking Records</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="flights.php">Flights</a>
          </li>
          <li class="nav-item">
