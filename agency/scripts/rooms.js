...
function add_room()
{
  ...
  data.append('address',add_room_form.elements['address'].value);
...
function edit_details(id)
{
  ...
  xhr.onload = function(){
    ...
    edit_room_form.elements['address'].value = data.roomdata.address;
...
function submit_edit_room()
{
  ...
  data.append('address',edit_room_form.elements['address'].value);
