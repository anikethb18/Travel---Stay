  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-2" href="tours.php">Tours</a>
        </li>
        <li class="nav-item">
            ...
            echo<<<data
              <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-lg-end">
                  ...
                  <li><a class="dropdown-item" href="flight_bookings.php">Flight Bookings</a></li>
                  <li><a class="dropdown-item" href="tour_bookings.php">Tour Bookings</a></li>
