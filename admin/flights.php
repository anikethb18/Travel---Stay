                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="time" name="departure_time" class="form-control shadow-none" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Arrival Time</label>
                                            <input type="time" name="arrival_time" class="form-control shadow-none" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Travel ID</label>
                                            <input type="text" name="travel_id" class="form-control shadow-none">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Travel Agency</label>
                                            <input type="text" name="travel_agency" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    <div class="mb-3">
